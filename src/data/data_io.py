...
from src.core.cache_config import CACHE_CATEGORY_SESSION
from src.core.invalidation import invalidate_all_db_caches, invalidate_export_caches
...
def export_scanned_receipts_to_csv(file_path: str) -> bool:
    ...
    """
    import csv
    from src.core.database import get_scanned_receipts_history
