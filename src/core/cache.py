...
from src.core.cache_config import CACHE_CATEGORIES
from src.core.cache_metrics import (
    record_fresh_hit,
    record_invalidation,
    record_miss,
...
def invalidate_category(category: str) -> None:
    ...
    from src.core.invalidation import get_cached_functions_for_category
